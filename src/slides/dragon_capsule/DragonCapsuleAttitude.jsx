...
function DragonCapsuleAttitude() {
  return (
    <>
      <div className='first-stage-desc dragon-capsule-attitude'>
      ...
      <div className='overview-values height'>
        ...
        <div className='value'>
          400N<span className='overview-text-primary'>/ 90 lbf</span>
        </div>
      </div>
      <div className='overview-divider' />
    </>
...
export default DragonCapsuleAttitude